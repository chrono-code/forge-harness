...
> 🟥 **これは名前の由来であって手順ではありません — 数えないでください。** 下の鍛冶屋の言葉は
> **語彙**であって、段階のリストではありません。上の **3段工程 · 4大エンジン · 4軸ゲート ·
> 6軸検証とは別の層**であり、そのどの数字とも対応しません。この節が起こしうる唯一の誤解が
> 「5つめの番号付きの集合」として読まれることなので、ここで先に断っておきます。

**金床の上で三つ:**

| 鍛冶屋の言葉 | ここでは何を指すか | コマンド |
|---|---|---|
