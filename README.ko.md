...
[`ship_readiness_gate.md`](knowledge/shared/harness-core/ship_readiness_gate.md) — 정체성마다
현재 등급이 날짜와 그 등급을 얻은 근거와 함께 적혀 있습니다. 전부 초록은 아니고, 무엇이 언제인지는
그 파일이 말합니다.
...
| **ⓔ 첫실사용** | 실물 대상 한 건 | **재는 방식**이 틀림 · 계기의 계기 | 진짜 대상 하나에 돌리고 결과를 손으로 확인 |
...
| **4축 검증** | → **6축 검증**으로 확장됨 | **3단 공정 ③단계**의 내용물 |
