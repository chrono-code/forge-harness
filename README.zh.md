...
<p align="center">
  <b>forge-harness 是一座把反复出现的意图锻造成机器的锻炉 —— 也是框架诞生的地方。</b>
</p>

<p align="center">
  你一遍遍对 Claude Code 重复的那些事，会变成住在你仓库里、自己发火的技能、闸门和 agent。<br>
  <b>你换到的东西：试错从你身上剥离，并行地跑。</b>
</p>
...
<sub>🟥 <b>关于最后这一点，说实话</b>：语言对齐是一条 <b>没有机械门禁兜底</b> 的散文规则，它并不总是
成立。2026-08-21 的盲测（floor 档）里，日语 <b>3/3</b> 命中，中文只有 <b>1/5</b>（没中的那几次它用韩语
或英语回了）。所以如果它回错了语言，直接说一声，它就会切过来。这条残留被如实写在
...
- **如何验证** —— 它公开自己的评级。五个身份，如实记录在每一次
  [发布](https://github.com/chrono-meta/forge-harness/releases)中。未变绿的那些，会指名说出
  还缺哪一次真实运行。
