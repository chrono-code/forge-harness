...
| TR 29119-11 test-oracle problem | expected results when none exist | known-pair controls in the same run · scorer fixed before results · "not found ≠ 0" · `UNCALIBRATED` | `measurement-integrity-checklist.md` | ✅ mechanism / ❌ oracle *type* not recorded (candidate M1) |
