...
| `ko-tech-writer` | Korean technical-writing pipeline — register detection, venue calibration, translationese scan, honesty layering, number/claim gate, perceptual QA, **spoken-script pass (Step 5-s: sound render + listening QA)** | Field-session harvest (2026-08-10 conference tech-doc revision; spoken register added 2026-08-25) |
